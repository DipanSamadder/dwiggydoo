...
class BusinessSettingsController extends Controller
{
     function __construct(){
        ...
        $this->middleware('permission:show frontend setting|edit frontend setting', ['only' => ['frontend_setting']]);
       
        $this->middleware('permission:show backend setting|edit backend setting', ['only' => ['backend_setting']]);
