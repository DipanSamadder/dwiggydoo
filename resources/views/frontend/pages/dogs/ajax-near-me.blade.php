@if(!is_array($near_me_dogs) && count($near_me_dogs) > 0)
<div class="conn_profile_list">
    <ul>
        @foreach($near_me_dogs as $key=> $value)
        @php 
            ...
            <div class="connection_right_box">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="dog_connection_button">
                        <button type="button" onclick="sendFriendRequest('{{ Session::get('defaultDogDetails.id') }}','{{ $value->id }}', 'near_me_profile')">add friend</button>
                    </div>
                    </div>
                </div>
                </div>
