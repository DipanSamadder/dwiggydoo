    ...
    <div class="row clearfix">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <select class="form-control show-tick ms select2" name="cat_type">
                    ...
                    <option value="leadership" @if($data->cat_type == 'leadership')  selected @endif>Leadership</option>
                    <option value="governance" @if($data->cat_type == 'governance')  selected @endif>Governance</option>
                    <option value="faculty_data" @if($data->cat_type == 'faculty_data')  selected @endif>Faculty</option>
                </select>
            </div>
        </div>
        <div class="col-sm-2">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="text" name="short_content" class="form-control" placeholder="Designation" value="{{ $data->short_content }}" />                                   
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
        ...
        <div class="col-sm-12">
            <div class="form-group">                                 
                <textarea class="summernote" name="content" onchange="is_edited()" rows="4" cols="50">
                    <?php $str = $data->content; echo htmlspecialchars_decode($str); ?>
                </textarea>                            
            </div>
        </div>
    </div>
