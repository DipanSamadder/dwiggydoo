                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent" id="parent" onchange="is_edited()">
                                        ...
                                        @foreach(App\Models\Page::where('type', 'department_page')->where('level', 2)->where('status', 1)->get() as $key => $value)
                                            
                                            <option value="{{ $value->id }}">{{ $value->title }}</option>
                                            @php
                                                $child = App\Models\Page::where('parent', $value->id)->where('type', 'department_page')->where('level', 3)->where('status', 1)->get();
                                            @endphp
                                            @if($child != '')
