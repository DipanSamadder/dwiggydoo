    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                <div class="col-lg-4">
                    @if(dsld_have_user_permission('departments_add') == 1)
                    ...
                    <form class="form-inline" id="search_media">
                        ...
                        <div class="col-lg-4 form-group">                                
                            <select class="form-control" name="temp" onchange="filter()">
                                ...
                                <option value="school_department">Department</option>
                                <option value="school_details">School</option>
                            </select>
                        </div>
                        <div class="col-lg-4 form-group">                                
