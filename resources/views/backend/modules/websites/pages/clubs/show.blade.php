...
@endphp
 ...
 <div class="row clearfix">
    @if(dsld_have_user_permission('clubs_add') == 1)
    <div class="col-lg-8">
    @else
    <div class="col-lg-12">
    @endif
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <input type="hidden" name="type" id="type" value="clubs_page" />
                            @csrf 
                            <div class="modal-body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">       
                                            <label class="form-label">Photo </label><a class="btn btn-primary text-white" onclick="media_file_get('{{ @$data->banner }}','put_image', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image">@if(isset($data->banner))<strong>Selected Image:</strong><i> {{ @$data->banner }}</i>@endif</div>
...
@section('footer')
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('clubs.get_ajax_files') }}">
