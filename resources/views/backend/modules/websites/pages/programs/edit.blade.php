                ...
                <div class="body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="template" id="template" onchange="is_edited()">
                            ...
                            <option value="program_school_lists"  @if($data->template == 'program_school_lists') selected @endif>Program List</option>
                            <option value="program_school_details"  @if($data->template == 'program_school_details') selected @endif>Program Details</option>
                        </select>                             
                    </div>
            ...
            <div class="card mb-0">
                ...
                <div class="body">
                    <div class="form-group">
                        ...
                        <!-- <select class="form-control show-tick ms select2" name="banner" id="banner" onchange="is_edited()">
                            <option value="">-- Please select --</option>
                            @foreach(App\Models\Upload::where('type', 'image')->get() as $key => $value)
                ...
                <div class="body">
                    <div class="form-group">
                        ...
                        <a class="btn btn-primary text-white" onclick="media_file_get('{{ @$data->thumbnail }}','put_image2', 0)"><i class="zmdi zmdi-collection-image"></i></a><div class="put_image2">@if(isset($data->thumbnail))<strong>Selected Image:</strong><i> {{ @$data->thumbnail }}</i>@endif</div>
                                
                        <input type="hidden" class="put_image2" name="thumbnail" id="thumbnail" value="{{ @$data->thumbnail }}" onchange="is_edited()">
                        @if($data->thumbnail > 0)
                        <div class="image mt-2">
                            <img src="{{ dsld_uploaded_asset($data->thumbnail) }}"  alt="{{ dsld_upload_file_title($data->thumbnail) }}" class="img-fluid" width="100px">
                        </div> 
                        @endif    
