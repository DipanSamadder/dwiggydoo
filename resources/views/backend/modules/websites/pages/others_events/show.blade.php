...
@endphp
 ...
 <div class="row clearfix">
    @if(dsld_have_user_permission('others-events_add') == 1)
    <div class="col-lg-8">
    @else
    <div class="col-lg-12">
    @endif
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('others_event.store') }}" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control show-tick ms select2" name="cat_type">
                                                ...
                                                <option value="exam_announcement">Exam Announcement</option>
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('others_event.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('others_event.get_ajax_files') }}">
