                ...
                <div class="body">
                    <div id="form_elements">
                        ...
                        @foreach (json_decode($data->meta_fields) as $key => $element)
								...
								@if ($element->type == 'text' || $element->type == 'image_box'  || $element->type == 'mission' || $element->type == 'link_box' || $element->type == 'program' || $element->type == 'faculty' || $element->type == 'image_box_repeter' ||$element->type == 'button' || $element->type == 'editor' || $element->type == 'file' || $element->type == 'text_repeter' || $element->type == 'file_repeter')
