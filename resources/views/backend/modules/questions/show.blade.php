    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('questions.store') }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="option-target">
                                                <div class="row gutters-5">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Option" name="options[]" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-auto">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"  name="published_date" placeholder="Publish Date" data-format="DD-MM-Y" data-advanced-range="false" autocomplete="off" onchange="date_change();" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="name">Type</label>
                                            <select name="type" class="form-control selectpicker"  id="question_type_data">
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('questions.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
    	...
    	$.ajax({
    		...
    		success: function(data){
    			...
    			$.each(objkeys, function (key, value) { 
					...
					$('#question_type_data').append($('<option>').text(value.name).val(value.id));
                    $('#question_type_data').selectpicker('refresh');
				})
    		}
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_questions') }}">
