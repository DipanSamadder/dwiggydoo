    ...
    <div class="row clearfix">
                ...
                <div class="edit-option-target">
                    @if(!empty($data->option))
                        ...
                        <div class="row edit-row gutters-5">
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Options" name="option[]" value="{{ $value }}">
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="date" class="form-control"  name="published" placeholder="Publish Date" data-format="DD-MM-Y" data-advanced-range="false" autocomplete="off" required value="{{ date('Y-m-d', strtotime($data->published)) }}">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label for="name">Expired</label>
                <input type="date" class="form-control"  name="expire_at" placeholder="Expired" data-format="DD-MM-Y" data-advanced-range="false" autocomplete="off" required value="{{ date('Y-m-d', strtotime($data->expire_at)) }}">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">                                 
